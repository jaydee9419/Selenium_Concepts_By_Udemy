...
Download file
====================
1. when i click download file, will open to same or another winodow instade of downloading Eg PDF file 
...
def Edge_setup():
    # below 3 lines required to download files in desired location 
    preferences = {"download.default_directory": "C:\\Users\\11571\\Downloads\\Docs", "plugins.always_open_word_externally": True}
